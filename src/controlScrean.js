...
let fullscreenAttention = new PIXI.Text( "PCの場合、オススメ解像度は1920x1080です。また、全画面表示にしてリロードする(F5を押す)ことをオススメします。", { fill: 0x00ac9b,fontSize: 22.5*compressionSquare,fontFamily: textfont } );//フルスクリーンに誘導
...
async function setStartScene(){
  ...
  hallucinationCaution1.x = 450*compressionSquare
  hallucinationCaution1.y = 700*compressionSquare
  hallucinationCaution2.x = 450*compressionSquare
  hallucinationCaution2.y = 750*compressionSquare
  fullscreenAttention.x = 450*compressionSquare
